...
export const metadata = {
  title: "Capabilities",
  description:
    "Operator-led capabilities across the energy asset lifecycle: diligence, repower and performance recovery, commissioning, operations and maintenance, controls, and interconnection.",
};
      ...
      <section className="page-hero page-hero--photo">
        ...
        <div className="container">
          ...
          <p className="page-lede">
            ...
            capabilities we bring to the owners and developers who hire us, and to
            the assets we operate ourselves.
          </p>
        </div>
      </section>
